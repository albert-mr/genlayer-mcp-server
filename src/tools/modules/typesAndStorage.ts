...
${
  params.complexity_level === 'advanced' && params.include_examples
    ? `### Complex DynArray Usage:
\`\`\`python
@allow_storage
@dataclass
class Task:
